...
class Table:
    ...
    def Preprocessing(self):
        ...
        for i in range(len(df3)):
            # Parse the RFC 2822 time string and Convert the time to the desired format
    ...
    #filtering emails recieved in a timestamp
